...
import ImageChops, sys, ImageDraw, serial, time, bisect, scipy
...
def getImage(cam):
    imstream = io.BytesIO()
    cam.capture(imstream,format = 'jpeg')
    imstream.seek(0)
...
##            Dist2 = ord(Dist2)
        ...
        if not Gate < 120: # If "Gate" is not open
            ...
            ir1 = getImage(cam)   # Always take a new picture for reference
        ...
        t2 = time.clock()            
        ir2 = getImage(cam)   # Take a picture of the fire
