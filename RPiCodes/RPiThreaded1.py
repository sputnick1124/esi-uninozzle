...
def suppressFire_callback(channel):
    ...
    ysize , xsize = FireImage.shape # this block of code constructs the protection grid divisions
##    tmpIm = FireImage
    xsplit = xsize / 5
    ysplit = ysize / 5
...
try:
    ...
    t1.setDaemon(True)
    t1.start()
    GPIO.add_event_detect(17, GPIO.FALLING, callback = suppressFire_callback, bouncetime = 200)
##    GPIO.add_event_detect(16, GPIO.FALLING, callback = fireAllPorts_callback, bouncetime = 500)
